...
-- Drop the sub-tables I just created (referencing the old table or failed references)
...
-- Create V2 Main Table (to bypass permission issues on legacy table)
CREATE TABLE aibrewgenius.ai_generated_recipes_v2 (
