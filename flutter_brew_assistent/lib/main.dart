...
class _FiningAgentsPageState extends State<FiningAgentsPage> {
  ...
  Future<void> save() async {
    ...
    // Automatisch das "neue Mittel" hinzufügen, falls noch Text im Feld steht
    ...
    try {
      ...
      setState(() {
        settings = saved;
        // Die Liste der Controller synchronisieren, falls sie sich serverseitig geändert hat
        // Das ist wichtig, falls z.B. Duplikate entfernt wurden oder ähnliches.
        for (final ctrl in extraCtrls) {
          ctrl.dispose();
        }
        extraCtrls
